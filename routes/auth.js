...
passport.use(new TwitterStrategy({
  ...
  callbackURL: 'https://block-party-coreyjsax.c9users.io/auth/twitter/callback',
  includeEmail:true
},
  function(accessToken, refreshToken, profile, done) {
...
var GoogleStrategy = require('passport-google-oauth2').Strategy;
 ...
 passport.use(new GoogleStrategy({
  clientID: '787307841572-96on5lkdu3hnjjd0e02hm6h0kivtf7ml.apps.googleusercontent.com',
  clientSecret: '12Vw1zMI6feSLrCwZSeWuy9f',
  callbackURL: 'https://block-party-coreyjsax.c9users.io/auth/google/callback',
